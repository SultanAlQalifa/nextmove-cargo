...
CREATE INDEX IF NOT EXISTS idx_rfq_client ON rfq_requests(client_id);
CREATE INDEX IF NOT EXISTS idx_rfq_forwarder ON rfq_requests(specific_forwarder_id);
CREATE INDEX IF NOT EXISTS idx_rfq_expires ON rfq_requests(expires_at)
WHERE expires_at IS NOT NULL;
CREATE INDEX IF NOT EXISTS idx_rfq_created ON rfq_requests(created_at DESC);
CREATE INDEX IF NOT EXISTS idx_rfq_mode ON rfq_requests(transport_mode);
-- ═══ TABLE: rfq_offers ═══
...
-- Indexes pour performance
CREATE INDEX IF NOT EXISTS idx_offer_rfq ON rfq_offers(rfq_id);
CREATE INDEX IF NOT EXISTS idx_offer_forwarder ON rfq_offers(forwarder_id);
CREATE INDEX IF NOT EXISTS idx_offer_status ON rfq_offers(status);
CREATE INDEX IF NOT EXISTS idx_offer_submitted ON rfq_offers(submitted_at DESC);
CREATE INDEX IF NOT EXISTS idx_offer_expires ON rfq_offers(expires_at)
WHERE expires_at IS NOT NULL;
...
DROP POLICY IF EXISTS "Forwarders can view own offers" ON rfq_offers;
...
DROP POLICY IF EXISTS "Clients can view offers on their RFQs" ON rfq_offers;
...
DROP POLICY IF EXISTS "Forwarders can create offers" ON rfq_offers;
...
DROP POLICY IF EXISTS "Forwarders can update own pending offers" ON rfq_offers;
...
DROP POLICY IF EXISTS "Forwarders can delete own pending offers" ON rfq_offers;
...
DROP POLICY IF EXISTS "Clients can update offer status" ON rfq_offers;
...
DROP POLICY IF EXISTS "Admins can view all offers" ON rfq_offers;
...
DROP POLICY IF EXISTS "Admins can update all offers" ON rfq_offers;
...
DROP TRIGGER IF EXISTS on_offer_submitted ON rfq_offers;
...
DROP TRIGGER IF EXISTS set_offer_expiration_trigger ON rfq_offers;
