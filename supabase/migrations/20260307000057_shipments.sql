...
-- Shipments Policies
DROP POLICY IF EXISTS "Clients can view own shipments" ON shipments;
...
DROP POLICY IF EXISTS "Forwarders can view assigned shipments" ON shipments;
...
DROP POLICY IF EXISTS "Forwarders can update assigned shipments" ON shipments;
...
DROP POLICY IF EXISTS "Admins can manage all events" ON shipment_events;
