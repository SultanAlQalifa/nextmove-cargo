-- Improved Analytics with Real Growth and Conversion Rates
...
END IF;
-- Active Shipments (Snapshot, no growth usually)
...
-- Or 100 if started from 0, but 0 is safer for display
END IF;
