...
export const FEATURE_DEFINITIONS: FeatureDefinition[] = [
    // --- CORE / USAGE ---
    {
        ...
        description: 'Nombre maximum d\'expéditions qu\'un utilisateur peut créer par mois',
        type: 'limit',
        defaultValue: 10,
        category: 'usage'
    },
    ...
    },
    {
        ...
        description: 'Espace de stockage alloué pour les documents (factures, POD, etc.)',
        type: 'limit',
        defaultValue: 1,
        category: 'usage'
    },
    ...
    // --- FUNCTIONALITY ---
    {
        ...
        description: 'Possibilité de personnaliser le logo et les couleurs de l\'interface',
        type: 'boolean',
        defaultValue: false,
        category: 'core'
    },
    {
        ...
        description: 'Possibilité d\'exporter les données (Expéditions, Factures) en CSV/Excel',
        type: 'boolean',
        defaultValue: false,
        category: 'core'
    },
    {
        ...
        key: 'multi_currency',
        name: 'Multi-devises',
        description: 'Affichage et facturation dans plusieurs devises (EUR, USD, XOF)',
        type: 'boolean',
        defaultValue: false,
        category: 'core'
    },
    {
        ...
        description: 'Accès aux tableaux de bord de performance et rapports détaillés',
        type: 'boolean',
        defaultValue: false,
        category: 'core'
    },
    ...
    // --- INTEGRATION & SECURITY ---
    {
        ...
        key: 'api_access',
        name: 'Accès API',
        description: 'Accès aux clés API pour l\'intégration avec des systèmes externes',
        type: 'boolean',
        defaultValue: false,
    ...
    },
    {
        ...
        key: 'sso_login',
        name: 'Connexion SSO',
        description: 'Authentification unique (Single Sign-On) pour les entreprises',
        type: 'boolean',
        defaultValue: false,
        category: 'integration'
    },
    {
        ...
        key: 'webhook_access',
        name: 'Webhooks',
        description: 'Notifications en temps réel via Webhooks vers des services tiers',
        type: 'boolean',
        defaultValue: false,
        category: 'integration'
    },
    ...
    },
    {
        ...
        description: 'Création de multiples expéditions via import de fichier CSV/Excel',
        type: 'boolean',
        defaultValue: false,
        category: 'usage'
    },
    ...
    },
    {
        ...
        description: 'Permet d\'acheter des crédits pour dépasser les limites d\'expédition',
        type: 'boolean',
        defaultValue: false,
        category: 'core'
    },
    ...
    },
    {
        ...
        description: 'Valeur de marchandise assurée incluse dans l\'abonnement (en XOF)',
        type: 'limit',
        defaultValue: 0,
        category: 'core'
    },
    ...
    },
    {
        ...
        description: 'Génération automatique de Packing List et Factures Commerciales',
        type: 'boolean',
        defaultValue: false,
        category: 'usage'
    },
