...
function mapAppFeeToDb(appFee: any): any {
  ...
  if (appFee.gracePeriodHours !== undefined)
    dbFee.grace_period_hours = appFee.gracePeriodHours;
  if (appFee.recurringInterval !== undefined)
    dbFee.recurring_interval = appFee.recurringInterval;
  return dbFee;
}
