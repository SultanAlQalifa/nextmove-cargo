...
export const forwarderService = {
     ...
     */
    updateForwarder: async (id: string, data: Partial<ForwarderProfile>): Promise<void> => {
    ...
    inviteForwarder: async (email: string): Promise<void> => {
        ...
        // console.log(`Inviting forwarder with email: ${email}`);
     ...
     */
    uploadDocument: async (forwarderId: string, file: File, type: string): Promise<void> => {
