...
export const podService = {
    ...
    verifyPOD: async (id: string, status: 'verified' | 'rejected', notes?: string): Promise<void> => {
...
function mapDbPODToApp(dbRecord: any): POD {
    return {
        ...
        tracking_number: dbRecord.tracking_number || dbRecord.shipment?.tracking_number,
