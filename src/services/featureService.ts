...
export const featureService = {
    ...
    createFeature: async (feature: Omit<PlatformFeature, 'createdAt' | 'updatedAt'>): Promise<PlatformFeature> => {
    ...
    updateFeature: async (id: string, updates: Partial<PlatformFeature>): Promise<PlatformFeature> => {
...
function mapAppFeatureToDb(appFeature: any): any {
    ...
    if (appFeature.description !== undefined) dbFeature.description = appFeature.description;
    if (appFeature.category !== undefined) dbFeature.category = appFeature.category;
    if (appFeature.type !== undefined) dbFeature.type = appFeature.type;
    if (appFeature.defaultValue !== undefined) dbFeature.default_value = appFeature.defaultValue;
    return dbFeature;
}
