...
import { SubscriptionPlan, UserSubscription, CreatePlanData, UpdatePlanData } from '../types/subscription';
import { profileService } from './profileService';
import { generateSubscriptionContract, generateSubscriptionInvoice } from '../utils/pdfGenerator';
...
function mapAppPlanToDb(appPlan: any): any {
    ...
    if (appPlan.description !== undefined) dbPlan.description = appPlan.description;
    if (appPlan.price !== undefined) dbPlan.price = appPlan.price;
    if (appPlan.currency !== undefined) dbPlan.currency = appPlan.currency;
    if (appPlan.billing_cycle !== undefined) dbPlan.billing_cycle = appPlan.billing_cycle;
...
function calculateEndDate(billingCycle: 'monthly' | 'quarterly' | 'semiannual' | 'yearly'): string {
    const date = new Date();
