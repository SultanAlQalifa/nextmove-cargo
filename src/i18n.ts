...
const resources = {
    en: {
        translation: {
            ...
            "hero.subtitle": "The most secure and reliable logistics platform. We handle the shipping, customs, and payments so you can focus on growing your business.",
            ...
            "features.description": "We combine technology with on-the-ground expertise to solve the biggest challenges in cross-border trade.",
            "features.escrow.title": "Secure Escrow Payments",
            "features.escrow.desc": "Never worry about fraud again. Your funds are held securely in our escrow vault and only released to the forwarder when you confirm delivery.",
            "features.multimodal.title": "Multimodal Solutions",
            "features.multimodal.desc": "Whether you need speed (Air Freight) or cost-efficiency (Sea Freight), we instantly compare rates from top-rated forwarders.",
            "features.tracking.title": "End-to-End Tracking",
            "features.tracking.desc": "Real-time visibility from the supplier's warehouse in China to your doorstep in Africa. Know exactly where your cargo is 24/7.",

            // How It Works
            "howItWorks.title": "How It Works",
            "howItWorks.subtitle": "Shipping with NextMove Cargo is as easy as 1-2-3-4",
            "howItWorks.step1.title": "Get a Quote",
            "howItWorks.step1.desc": "Enter your cargo details and instantly get competitive rates.",
            "howItWorks.step2.title": "Book & Pay",
            "howItWorks.step2.desc": "Select the best offer and pay securely via Escrow.",
            "howItWorks.step3.title": "Track Cargo",
            "howItWorks.step3.desc": "Follow your shipment in real-time with our tracking dashboard.",
            "howItWorks.step4.title": "Confirm & Release",
            "howItWorks.step4.desc": "Inspect your goods upon arrival and release funds.",

            // Testimonials
            "testimonials.title": "Trusted by Businesses Across Africa",
            "testimonials.1.text": "NextMove Cargo changed my business. I used to worry about my goods getting lost or stolen. Now I sleep easy knowing my money is safe until I see my boxes.",
            "testimonials.1.name": "Amadou Diallo",
            "testimonials.1.role": "Importer, Senegal",
            "testimonials.2.text": "The rates are unbeatable. I saved 20% on my last shipment compared to my old agent. Plus, the tracking is actually accurate!",
            "testimonials.2.name": "Sarah Okafor",
            "testimonials.2.role": "Retailer, Nigeria",
            "testimonials.3.text": "As a supplier, I prefer clients who use NextMove. It builds trust instantly and the payment process is transparent for both sides.",
            ...
            // Footer
            "footer.tagline": "The trusted bridge for China-Africa trade. Secure, fast, and reliable.",
            ...
            "calculator.pageSubtitle": "Compare rates from verified forwarders and book your shipment in minutes.",
            ...
            "calculator.noRates": "No rates found for these criteria. Try adjusting your search.",
            "calculator.noQuotesFound": "No quotes found. Please check your criteria.",
            ...
            "marketplace.heroSubtitle": "Find groupage offers or respond to shipping requests.",
            ...
            "dashboard.upgrade.description": "Grow your business by accessing quote requests and managing your own shipments.",
            ...
            "calculator.sea.conditions": "Ideal for large volumes, economical solution",
            ...
            "calculator.standard.description": "Standard service with normal delivery time",
            ...
            "calculator.standard.transitNote": "Standard transit time according to chosen mode",

            "calculator.express.label": "Express (Fastest)",
            "calculator.express.description": "Priority service with accelerated delivery",
            ...
            "calculator.express.features.fastCustoms": "Accelerated customs clearance",
            ...
            "calculator.noRatesForwarder": "No rates available for this forwarder with these criteria.",
            ...
            "auth.testimonial": "NextMove has completely transformed how we handle our logistics. It's the partner we've been waiting for.",
            ...
            "rfq.messages.confirmAccept": "Are you sure you want to accept this offer? All other offers will be rejected.",
            "rfq.messages.confirmReject": "Are you sure you want to reject this offer?",
            ...
            "documents.messages.deleteConfirm": "Are you sure you want to delete this document?",
    ...
    fr: {
        translation: {
            ...
            "hero.subtitle": "La plateforme logistique la plus sûre et fiable. Nous gérons l'expédition, les douanes et les paiements pour que vous puissiez vous concentrer sur votre croissance.",
            ...
            "features.description": "Nous combinons la technologie avec une expertise terrain pour résoudre les plus grands défis du commerce transfrontalier.",
            "features.escrow.title": "Paiements Sécurisés par Séquestre",
            "features.escrow.desc": "Ne vous inquiétez plus jamais de la fraude. Vos fonds sont conservés en toute sécurité et libérés uniquement lorsque vous confirmez la livraison.",
            "features.multimodal.title": "Solutions Multimodales",
            "features.multimodal.desc": "Que vous ayez besoin de rapidité (Fret Aérien) ou d'économie (Fret Maritime), nous comparons instantanément les tarifs des meilleurs transitaires.",
            "features.tracking.title": "Suivi de Bout en Bout",
            "features.tracking.desc": "Visibilité en temps réel de l'entrepôt du fournisseur en Chine jusqu'à votre porte en Afrique. Sachez exactement où se trouve votre cargaison 24h/24 et 7j/7.",

            // How It Works
            "howItWorks.title": "Comment Ça Marche",
            "howItWorks.subtitle": "Expédier avec NextMove Cargo est aussi simple que 1-2-3-4",
            "howItWorks.step1.title": "Obtenir un Devis",
            "howItWorks.step1.desc": "Entrez les détails de votre cargaison et obtenez instantanément des tarifs compétitifs.",
            "howItWorks.step2.title": "Réserver et Payer",
            "howItWorks.step2.desc": "Sélectionnez la meilleure offre et payez en toute sécurité via Séquestre.",
            "howItWorks.step3.title": "Suivre la Cargaison",
            "howItWorks.step3.desc": "Suivez votre expédition en temps réel avec notre tableau de bord.",
            "howItWorks.step4.title": "Confirmer et Libérer",
            "howItWorks.step4.desc": "Inspectez vos marchandises à l'arrivée et libérez les fonds.",

            // Testimonials
            "testimonials.title": "Approuvé par les Entreprises à Travers l'Afrique",
            "testimonials.1.text": "NextMove Cargo a changé mon entreprise. J'avais l'habitude de m'inquiéter que mes marchandises soient perdues ou volées. Maintenant je dors tranquille sachant que mon argent est en sécurité jusqu'à ce que je voie mes colis.",
            "testimonials.1.name": "Amadou Diallo",
            "testimonials.1.role": "Importateur, Sénégal",
            "testimonials.2.text": "Les tarifs sont imbattables. J'ai économisé 20% sur ma dernière expédition par rapport à mon ancien agent. De plus, le suivi est vraiment précis !",
            "testimonials.2.name": "Sarah Okafor",
            "testimonials.2.role": "Détaillant, Nigeria",
            "testimonials.3.text": "En tant que fournisseur, je préfère les clients qui utilisent NextMove. Cela crée instantanément la confiance et le processus de paiement est transparent des deux côtés.",
            "testimonials.3.name": "Wei Chen",
            "testimonials.3.role": "Fournisseur, Guangzhou",

            // CTA
            "cta.title": "Prêt à optimiser votre logistique ?",
            "cta.subtitle": "Rejoignez des milliers d'entreprises qui expédient plus intelligemment aujourd'hui.",
            "cta.button": "Créer un Compte Gratuit",

            // Footer
            "footer.tagline": "Le pont de confiance pour le commerce Chine-Afrique. Sécurisé, rapide et fiable.",
            ...
            "calculator.subtitle": "Obtenez les meilleurs tarifs pour votre expédition instantanément.",
            "calculator.pageSubtitle": "Comparez les tarifs des transitaires vérifiés et réservez votre expédition en quelques minutes.",
            ...
            "calculator.noRates": "Aucun tarif trouvé pour ces critères. Essayez d'ajuster votre recherche.",
            "calculator.noQuotesFound": "Aucun devis trouvé. Veuillez vérifier vos critères.",
            ...
            "marketplace.heroSubtitle": "Trouvez des offres de groupage ou répondez aux demandes d'expédition.",
            ...
            "dashboard.upgrade.description": "Développez votre activité en accédant aux demandes de cotation et en gérant vos propres expéditions.",
            ...
            "calculator.sea.conditions": "Idéal pour gros volumes, solution économique",
            ...
            "calculator.air.conditions": "Rapide, idéal pour urgences et petits volumes",
            ...
            "calculator.standard.transitNote": "Temps de transit standard selon le mode choisi",

            "calculator.express.label": "Express (Le Plus Rapide)",
            "calculator.express.description": "Service prioritaire avec délai accéléré",
            ...
            "calculator.express.transitNote": "Réduction du temps de transit jusqu'à 40%",
            ...
            "calculator.compareForwardersDesc": "Comparer les offres de tous les partenaires",
            ...
            "calculator.noRatesForwarder": "Aucun tarif disponible pour ce transitaire avec ces critères.",
            ...
            "auth.signUpSubtitle": "Rejoignez des milliers d'entreprises qui expédient intelligemment",
            ...
            "auth.testimonial": "NextMove a complètement transformé notre gestion logistique. C'est le partenaire que nous attendions.",
            ...
            "rfq.form.targetForwarder": "Cibler un Transitaire Spécifique (Optionnel)",
            ...
            "rfq.messages.confirmAccept": "Êtes-vous sûr de vouloir accepter cette offre ? Toutes les autres offres seront rejetées.",
            "rfq.messages.confirmReject": "Êtes-vous sûr de vouloir rejeter cette offre ?",
            "rfq.messages.confirmCancel": "Êtes-vous sûr de vouloir annuler cette demande ?",
            ...
            "documents.empty.subtitle": "Commencez par importer votre premier fichier.",
            ...
            "documents.messages.deleteConfirm": "Êtes-vous sûr de vouloir supprimer ce document ?",
    ...
    es: {
        translation: {
            ...
            "hero.subtitle": "La plataforma logística más segura y confiable. Manejamos el envío, aduanas y pagos para que puedas enfocarte en hacer crecer tu negocio.",
            ...
            "features.description": "Combinamos tecnología con experiencia sobre el terreno para resolver los mayores desafíos del comercio transfronterizo.",
            "features.escrow.title": "Pagos Seguros en Depósito",
            "features.escrow.desc": "Nunca más te preocupes por fraudes. Tus fondos se mantienen seguros y solo se liberan cuando confirmas la entrega.",
            "features.multimodal.title": "Soluciones Multimodales",
            "features.multimodal.desc": "Ya sea que necesites velocidad (Flete Aéreo) o eficiencia de costos (Flete Marítimo), comparamos instantáneamente tarifas de los mejores transitarios.",
            "features.tracking.title": "Seguimiento de Extremo a Extremo",
            "features.tracking.desc": "Visibilidad en tiempo real desde el almacén del proveedor en China hasta tu puerta en África. Sabe exactamente dónde está tu carga 24/7.",

            // How It Works
            "howItWorks.title": "Cómo Funciona",
            "howItWorks.subtitle": "Enviar con NextMove Cargo es tan fácil como 1-2-3-4",
            "howItWorks.step1.title": "Obtener Cotización",
            "howItWorks.step1.desc": "Ingresa los detalles de tu carga y obtén tarifas competitivas al instante.",
            "howItWorks.step2.title": "Reservar y Pagar",
            "howItWorks.step2.desc": "Selecciona la mejor oferta y paga de forma segura vía Depósito.",
            "howItWorks.step3.title": "Rastrear Carga",
            "howItWorks.step3.desc": "Sigue tu envío en tiempo real con nuestro panel de seguimiento.",
            "howItWorks.step4.title": "Confirmar y Liberar",
            "howItWorks.step4.desc": "Inspecciona tus productos al llegar y libera los fondos.",

            // Testimonials
            "testimonials.title": "Confiado por Empresas en Toda África",
            "testimonials.1.text": "NextMove Cargo cambió mi negocio. Solía preocuparme de que mis productos se perdieran o robaran. Ahora duermo tranquilo sabiendo que mi dinero está seguro hasta que vea mis cajas.",
            "testimonials.1.name": "Amadou Diallo",
            "testimonials.1.role": "Importador, Senegal",
            "testimonials.2.text": "Las tarifas son inmejorables. Ahorré un 20% en mi último envío comparado con mi antiguo agente. ¡Además, el seguimiento es realmente preciso!",
            "testimonials.2.name": "Sarah Okafor",
            "testimonials.2.role": "Minorista, Nigeria",
            "testimonials.3.text": "Como proveedor, prefiero clientes que usan NextMove. Genera confianza instantáneamente y el proceso de pago es transparente para ambas partes.",
            "testimonials.3.name": "Wei Chen",
            "testimonials.3.role": "Proveedor, Guangzhou",

            // CTA
            "cta.title": "¿Listo para optimizar tu logística?",
            "cta.subtitle": "Únete a miles de empresas que envían de manera más inteligente hoy.",
            "cta.button": "Crear Cuenta Gratuita",

            // Footer
            "footer.tagline": "El puente confiable para el comercio China-África. Seguro, rápido y confiable.",
            ...
            "calculator.subtitle": "Obtenga las mejores tarifas para su envío al instante.",
            "calculator.pageSubtitle": "Compare tarifas de transitarios verificados y reserve su envío en minutos.",
            ...
            "calculator.fillForm": "Complete el formulario para obtener una cotización",
            "calculator.noRates": "No se encontraron tarifas para estos criterios. Intente ajustar su búsqueda.",
            "calculator.noQuotesFound": "No se encontraron cotizaciones. Por favor verifique sus criterios.",
            ...
            "marketplace.heroSubtitle": "Encuentre ofertas de grupaje o responda a solicitudes de envío.",
            ...
            "dashboard.upgrade.description": "Haga crecer su negocio accediendo a solicitudes de cotización y gestionando sus propios envíos.",
            ...
            "calculator.sea.conditions": "Ideal para grandes volúmenes, solución económica",
            ...
            "calculator.air.conditions": "Rápido, ideal para urgencias y pequeños volúmenes",
            ...
            "calculator.standard.description": "Servicio estándar con tiempo de entrega normal",
            ...
            "calculator.standard.transitNote": "Tiempo de tránsito estándar según el modo elegido",

            "calculator.express.label": "Express (El Más Rápido)",
            "calculator.express.description": "Servicio prioritario con entrega acelerada",
            ...
            "calculator.express.features.fastCustoms": "Despacho de aduanas acelerado",
            "calculator.express.transitNote": "Tiempo de tránsito reducido hasta un 40%",
            ...
            "calculator.platformRatesDesc": "Tarifas estándar garantizadas por NextMove",
            "calculator.compareForwarders": "Comparar Transitarios",
            "calculator.compareForwardersDesc": "Comparar ofertas de todos los socios",
            ...
            "calculator.noRatesForwarder": "No hay tarifas disponibles para este transitario con estos criterios.",
            ...
            "auth.signUpSubtitle": "Únete a miles de empresas que envían de manera inteligente",
            ...
            "auth.testimonial": "NextMove ha transformado completamente cómo manejamos nuestra logística. Es el socio que estábamos esperando."
        }
    },
    zh: {
        translation: {
            ...
            // Hero Section
            "hero.title": "连接中国与非洲",
            "hero.subtitle": "最安全可靠的物流平台。我们处理运输、海关和付款，让您专注于业务增长。",
            "hero.cta1": "获取即时报价",
            "hero.cta2": "立即开始运输",
            "hero.badge1": "托管保护",
            "hero.badge2": "72小时送达",
            ...
            "features.description": "我们将技术与实地专业知识相结合，解决跨境贸易中的最大挑战。",
            "features.escrow.title": "安全托管支付",
            "features.escrow.desc": "再也不用担心欺诈。您的资金安全保管在我们的托管金库中，只有在您确认收货后才会释放给货代。",
            "features.multimodal.title": "多式联运解决方案",
            "features.multimodal.desc": "无论您需要速度（空运）还是成本效益（海运），我们都会即时比较顶级货代的费率。",
            "features.tracking.title": "端到端追踪",
            "features.tracking.desc": "从中国供应商仓库到非洲您的门口，实时可见。全天候准确了解您的货物位置。",
            ...
            "testimonials.1.text": "NextMove Cargo 改变了我的生意。我过去常常担心货物丢失或被盗。现在我可以安心睡觉，因为我知道我的钱在我看到货物之前是安全的。",
            "testimonials.1.name": "Amadou Diallo",
            "testimonials.1.role": "进口商，塞内加尔",
            "testimonials.2.text": "价格无与伦比。与我以前的代理相比，我在上次运输中节省了20%。而且，追踪确实准确！",
            "testimonials.2.name": "Sarah Okafor",
            "testimonials.2.role": "零售商，尼日利亚",
            "testimonials.3.text": "作为供应商，我更喜欢使用 NextMove 的客户。它立即建立信任，付款流程对双方都是透明的。",
            "testimonials.3.name": "Wei Chen",
            ...
            "calculator.pageSubtitle": "比较认证货代的费率，并在几分钟内预订您的货运。",
            ...
            "auth.testimonial": "NextMove 彻底改变了我们处理物流的方式。这是我们一直在等待的合作伙伴。"
        }
    }
};
