    ...
    return (
        <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-6">
                <div className="bg-white dark:bg-slate-900 rounded-[2.5rem] p-6 border border-slate-100 dark:border-white/5 shadow-xl">
                ...
                <div className="bg-gradient-to-br from-blue-600 to-indigo-700 rounded-[2.5rem] p-6 text-white shadow-xl relative overflow-hidden">
                    <Gift className="absolute -right-4 -bottom-4 w-24 h-24 text-white/10 rotate-12" />
