...
export default function ForwarderQuoteRequests() {
    ...
    return (
        <div className="space-y-6">
            <h2 className="text-xl font-bold text-gray-900">Pending Quote Requests</h2>

            <div className="grid grid-cols-1 gap-6">
                {requests.map((request) => (
                    <div key={request.id} className="bg-white shadow sm:rounded-lg p-6 border hover:border-primary transition">
                            ...
                            <div className="flex items-start space-x-4">
                                ...
                                <div>
                                    ...
                                    <div className="mt-2 text-sm text-gray-700">
                                        <p><span className="font-semibold">Cargo:</span> {request.cargo_details.description}</p>
                                        {request.cargo_details.weight_kg && <p>Weight: {request.cargo_details.weight_kg} kg</p>}
                                        {request.cargo_details.volume_cbm && <p>Volume: {request.cargo_details.volume_cbm} CBM</p>}
                                    </div>
                                </div>
                            </div>
