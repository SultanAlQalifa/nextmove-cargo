...
import { Plus, Package, Anchor, Plane, ArrowRight, Calendar, Upload } from 'lucide-react';
        ...
        <div className="space-y-6">
            ...
            {loading ? (
                ...
                <div className="text-center py-12 bg-white rounded-xl border border-dashed border-gray-300">
                    ...
                    <h3 className="text-lg font-medium text-gray-900">Aucun groupage pour le moment</h3>
                    <p className="text-gray-500 mb-6">Créez votre première offre de groupage pour commencer à remplir vos conteneurs.</p>
                    <button
                        onClick={() => setIsCreateModalOpen(true)}
                                ...
                                <div className="space-y-3 mb-6">
                                    <div className="flex justify-between text-sm">
                                        ...
                                        <span className="font-medium text-gray-900">
                                            {item.departure_date ? format(new Date(item.departure_date), 'dd MMM yyyy') : 'À définir'}
                                        </span>
                                    </div>
                                    <div className="flex justify-between text-sm">
