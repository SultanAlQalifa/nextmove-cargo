            ...
            {isOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                    ...
                    <motion.div
                        ...
                        className="relative w-full max-w-lg bg-white dark:bg-slate-900 rounded-2xl shadow-2xl overflow-hidden border border-amber-500/20"
                    >
                        {/* Glossy Header Effect */}
                        <div className="absolute top-0 inset-x-0 h-40 bg-gradient-to-br from-amber-400 via-amber-500 to-orange-600 opacity-10" />
                        <div className="absolute top-0 inset-x-0 h-1 bg-gradient-to-r from-amber-300 via-yellow-400 to-orange-500" />

                        <button
                            onClick={handleDismiss}
                            aria-label="Fermer"
                            className="absolute top-4 right-4 p-2 bg-white/50 dark:bg-black/20 hover:bg-white/80 rounded-full transition-colors z-10"
                        >
                            <X className="w-5 h-5 text-slate-500" />
                        </button>

                        <div className="relative p-6 md:p-8 text-center space-y-6">

                            <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-gradient-to-br from-amber-100 to-orange-100 dark:from-amber-900/30 dark:to-orange-900/30 mb-2 ring-8 ring-amber-50 dark:ring-amber-900/10">
                            ...
                            <div className="bg-amber-50 dark:bg-amber-900/20 rounded-xl p-6 border border-amber-100 dark:border-amber-800/50">
                                <div className="flex items-baseline justify-center gap-1 mb-4">
                                    ...
                                    <span className="text-sm text-amber-600/60 dark:text-amber-400/60 font-medium">/ unique</span>
                                </div>
