  ...
  return (
    <div className="py-24 bg-white dark:bg-gray-900 border-t border-slate-100 dark:border-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-blue-600 dark:text-blue-400 font-bold tracking-[0.4em] uppercase text-[10px] mb-4">
            {t("marketplace.title")}
          </h2>
          <p className="text-5xl lg:text-7xl font-black text-slate-900 dark:text-white mb-8 tracking-tighter">
            {t("marketplace.heroTitle")?.split('.')[0]}. <span className="text-gradient">Marketplace</span>
          </p>
          ...
          <div className="inline-flex p-1.5 bg-slate-100 dark:bg-slate-800/50 backdrop-blur-md rounded-2xl border border-slate-200 dark:border-white/5">
            {[
            ...
            {filteredOffers.map((offer) => {
              ...
              return (
                <motion.div
                  ...
                  className={`group relative rounded-[3rem] p-8 transition-all duration-500 overflow-hidden flex flex-col h-full ${isGroupageView
                    ? "bg-slate-900 text-slate-200 shadow-2xl shadow-emerald-900/10 hover:shadow-emerald-900/20 border border-white/5"
                    : "glass-card-premium text-slate-600 dark:text-slate-300 shadow-xl shadow-slate-200/50 dark:shadow-none hover:shadow-2xl hover:shadow-blue-500/10 border border-slate-100 dark:border-white/10"
                    }`}
                >
                  {/* Soft Ambient Glows */}
                  {isGroupageView ? (
                  ...
                  <div className="relative z-10 flex flex-col gap-6 mb-8">
                    <div className="flex justify-between items-start">
                      ...
                      <div className="flex items-center gap-3">
                        <div
                          className={`w-14 h-14 rounded-2xl flex items-center justify-center shadow-lg transform group-hover:rotate-6 transition-transform duration-500 ${isGroupageView
                        ...
                        <div className="flex flex-col">
                          ...
                          <span
                            className={`text-[10px] font-medium px-2 py-0.5 rounded-full w-fit mt-1 ${isGroupageView
                      ...
                      <div className={`flex flex-col items-end`}>
                        <span
                          className={`text-xs font-bold uppercase tracking-wider mb-1 ${isGroupageView ? "text-slate-400" : "text-slate-400"
                            }`}
                        >
                          {t("marketplace.officialRate")}
                        </span>
                        <div
                          className={`px-4 py-2 rounded-xl text-lg font-bold border backdrop-blur-md ${isGroupageView
                    ...
                    <div>
                      <div
                        className={`text-xs font-bold uppercase tracking-widest mb-2 ${isGroupageView
                      ...
                      <h3
                        className={`text-xl font-bold leading-tight ${isGroupageView ? "text-white" : "text-slate-900"
                          }`}
                      >
                        {offer.origin_port}{" "}
                  ...
                  {/* Detailed Timeline */}
                  <div
                    className={`relative z-10 mb-8 p-5 rounded-3xl border ${isGroupageView
                    ...
                    <div className="flex items-center justify-between text-center relative">
                      ...
                      <div className="flex-1 px-4 flex flex-col items-center relative -mt-1">
                        ...
                        <div className="w-full h-px bg-slate-300 dark:bg-slate-700 relative">
                          <div
                            className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-2 h-2 rounded-full ${isGroupageView ? "bg-emerald-500" : "bg-blue-500"
                              }`}
                          ></div>
                        </div>
                      </div>
