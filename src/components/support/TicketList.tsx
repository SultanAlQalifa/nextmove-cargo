          ...
          >
            <div className="flex justify-between items-start mb-2">
              <div className="flex items-center gap-3">
                <div
                  className={`p-2 rounded-lg ${ticket.status === "resolved" ? "bg-green-50" : "bg-blue-50"}`}
                >
                  <MessageCircle
                    className={`w-5 h-5 ${ticket.status === "resolved" ? "text-green-600" : "text-blue-600"}`}
                  />
                </div>
                <div>
              ...
              <div className="flex items-center gap-2">
                <span
                  className={`px-2.5 py-1 rounded-full text-xs font-bold border ${getStatusStyle(ticket.status)}`}
                >
