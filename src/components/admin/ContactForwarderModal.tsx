...
interface ContactForwarderModalProps {
    ...
    onSendMessage: (id: string, subject: string, message: string) => Promise<void>;
}

export default function ContactForwarderModal({ isOpen, onClose, forwarder, currentUserEmail, onSendEmail, onSendMessage }: ContactForwarderModalProps) {
                    ...
                    <div className="grid grid-cols-1 gap-4">
                        <div className="flex gap-2">
                            ...
                            >
                                ...
                                <div>
                                    <h4 className="font-semibold text-gray-900">Envoyer un email</h4>
                                    <p className="text-sm text-gray-500">Ouvrir votre client de messagerie</p>
                                </div>
                            </button>
                            <button
                                onClick={() => {
                        ...
                        >
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-500">Discuter directement via le chat</p>
                            </div>
                        </button>
                    </div>
                </div>
