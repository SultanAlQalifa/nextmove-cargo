...
export default function InviteForwarderModal({ isOpen, onClose }: InviteForwarderModalProps) {
        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-in fade-in duration-200">
            <div className="bg-white rounded-2xl w-full max-w-md shadow-xl animate-in zoom-in-95 duration-200 overflow-hidden">
                <div className="flex justify-between items-center p-6 border-b border-gray-100">
                    <h2 className="text-xl font-bold text-gray-900">Inviter un Transitaire</h2>
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-4">
                    <div className="p-4 bg-blue-50 rounded-xl flex gap-3 items-start">
                        ...
                        <div>
                            <h3 className="text-sm font-medium text-blue-900">Invitation par email</h3>
                            <p className="text-xs text-blue-700 mt-1">
                                Le transitaire recevra un email contenant un lien sécurisé pour créer son compte et soumettre ses documents.
                            </p>
                        </div>
                    </div>
