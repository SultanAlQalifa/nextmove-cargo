  ...
  return (
    <div className="fixed inset-0 bg-gray-900/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
        ...
        <div className="pt-12 pb-8 px-8">
          ...
          <div className="mt-8 pt-6 border-t border-gray-100 flex justify-end gap-3">
            ...
            <button
              ...
              className="px-4 py-2 border border-blue-200 text-blue-600 hover:bg-blue-50 rounded-xl transition-colors font-medium flex items-center gap-2"
            >
      ...
      <ConfirmationModal
        ...
        onClose={() => {
          if (!resetLoading) setShowConfirmReset(false);
        }}
        onConfirm={async () => {
        ...
        message={`Voulez-vous vraiment envoyer un email de réinitialisation de mot de passe à ${user.name} (${user.email}) ?`}
