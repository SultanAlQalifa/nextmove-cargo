...
interface PODRejectionModalProps {
  isOpen: boolean;
  onClose: () => void;
  pod: POD | null;
...
export default function PODRejectionModal({
  isOpen,
  onClose,
  pod,
  onConfirm,
}: PODRejectionModalProps) {
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              placeholder="Veuillez expliquer pourquoi ce document est rejeté..."
            />
          </div>
          ...
          <div className="flex justify-end gap-3 pt-2">
            ...
            <button
              ...
              className="px-4 py-2 text-sm font-medium text-white bg-red-600 hover:bg-red-700 rounded-lg shadow-sm shadow-red-600/20 transition-all disabled:opacity-50 flex items-center gap-2 min-h-[44px]"
            >
