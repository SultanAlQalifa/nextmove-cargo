import { X, FileText, DollarSign, Calendar, Truck, User, CheckCircle } from 'lucide-react';
...
export default function QuoteDetailsModal({ rfqId, onClose }: QuoteDetailsModalProps) {
    // Mock quote data
    const quote = {
        id: 'Q-2024-001',
        amount: 1250.00,
            ...
            <div className="bg-white rounded-2xl w-full max-w-lg shadow-2xl animate-in fade-in zoom-in duration-200 overflow-hidden">
                ...
                <div className="flex justify-between items-center p-6 border-b border-gray-100 bg-gray-50/50">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-xl font-bold text-gray-900">Devis pour {rfqId}</h2>
                            <p className="text-sm text-gray-500">Proposé par {quote.forwarder.name}</p>
                        </div>
                    </div>
                    <button
                        onClick={onClose}
                ...
                <div className="p-6 space-y-6">
                    <div className="flex items-center justify-center py-6 bg-green-50 rounded-2xl border border-green-100">
                        <div className="text-center">
                            ...
                            <p className="text-4xl font-bold text-green-700">
                                {quote.amount.toLocaleString('fr-FR', { style: 'currency', currency: quote.currency })}
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="p-4 bg-gray-50 rounded-xl border border-gray-100">
                            ...
                            <p className="font-semibold text-gray-900">{quote.transit_time}</p>
                        </div>
                    </div>

                    <div className="space-y-3">
                        <h3 className="text-sm font-medium text-gray-900">Notes du transitaire</h3>
