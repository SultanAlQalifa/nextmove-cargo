                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-4">
                    <div className="bg-green-50 p-4 rounded-xl flex gap-3">
                        ...
                        <div className="text-sm text-green-800">
                            ...
                            <p className="mt-1">L'expédition sera marquée comme livrée. Cette action est irréversible.</p>
                        </div>
                    </div>

                    <div className="space-y-2">
                        <label className="text-sm font-medium text-gray-700">Note de validation <span className="text-red-500">*</span></label>
                        <textarea
                            required
                            value={note}
