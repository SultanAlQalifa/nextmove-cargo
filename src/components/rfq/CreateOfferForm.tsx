...
export default function CreateOfferForm() {
    ...
    const calculateTotal = () => {
        ...
        return base_price + insurance_price + customs_clearance_price + door_to_door_price + packaging_price + storage_price + other_fees;
    };
        ...
        <div className="max-w-4xl mx-auto pb-12">
            ...
            <div className="mb-8">
                ...
                <p className="text-gray-500 mt-1">
                    Pour la demande: <span className="font-medium text-gray-900">{rfq.origin_port} → {rfq.destination_port}</span>
                </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="col-span-2 md:col-span-1">
                            <label className="block text-sm font-medium text-gray-700 mb-1">Fret de base *</label>
                        ...
                        {/* Additional Fees */}
                        {[
                            { name: 'customs_clearance_price', label: 'Dédouanement' },
                            ...
                            <div key={field.name}>
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        name={field.name}
                                        min="0"
                                        value={formData[field.name as keyof CreateOfferData] as number}
                                        onChange={handleInputChange}
                                        className="w-full pl-4 pr-12 py-2.5 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary"
                                    />
                                    <span className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-500 text-sm">{formData.currency}</span>
                                </div>
                            </div>
                        ))}
                    </div>
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">Temps de transit estimé (jours) *</label>
                            <input
                                type="number"
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">Validité de l'offre (jours) *</label>
                            <input
                                type="number"
                                name="validity_days"
                                required
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">Date de départ prévue</label>
                            <input
                                type="date"
                                name="departure_date"
