    ...
    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all duration-300 overflow-hidden group">
      <div className="p-6">
        <div className="flex justify-between items-start mb-4">
          ...
          <span
            className={`px-3 py-1 rounded-full text-xs font-bold border flex items-center gap-1.5 ${getStatusStyle(invoice.status)}`}
          >
        ...
        <div className="space-y-3 mb-6">
          ...
          <div className="flex justify-between text-sm">
            ...
            <span
              className={`font-medium ${invoice.status === "overdue" ? "text-red-600" : "text-gray-900"}`}
            >
        ...
        <div className="flex gap-3">
          ...
          <button
            ...
            className={`py-2.5 px-4 rounded-xl text-sm font-bold border transition-colors flex items-center justify-center gap-2 ${
              invoice.status === "paid"
