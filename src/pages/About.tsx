        ...
        <div className="bg-white dark:bg-gray-950 font-sans">
                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8 text-center relative z-10">
                    <div className="mx-auto max-w-3xl">
                        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 backdrop-blur-md mb-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
                            <span className="text-sm font-medium text-blue-100 tracking-wide uppercase">Notre Histoire & Vision</span>
                        </div>
                        ...
                        <p className="mt-6 text-xl leading-relaxed text-blue-100 max-w-2xl mx-auto font-light animate-in fade-in slide-in-from-bottom-6 duration-700 delay-200">
                            {about?.subtitle || "NextMove Cargo est la première plateforme digitale qui simplifie, sécurise et accélère vos importations de la Chine vers l'Afrique."}
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="relative -mt-16 z-20 max-w-7xl mx-auto px-6 lg:px-8">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8 bg-white dark:bg-gray-900 rounded-[2.5rem] p-8 md:p-12 shadow-2xl shadow-slate-200/50 dark:shadow-none border border-slate-100 dark:border-slate-800 animate-in fade-in slide-in-from-bottom-12 duration-1000 delay-300">
                    <div className="text-center space-y-2">
                        <div className="text-4xl lg:text-5xl font-bold text-blue-600 dark:text-blue-400">5+</div>
                        <div className="text-sm font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wide">Années d'Expérience</div>
                    </div>
                    <div className="text-center space-y-2">
                        <div className="text-4xl lg:text-5xl font-bold text-blue-600 dark:text-blue-400">10k+</div>
                        <div className="text-sm font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wide">Clients Satisfaits</div>
                    </div>
                    <div className="text-center space-y-2">
                        <div className="text-4xl lg:text-5xl font-bold text-blue-600 dark:text-blue-400">50k+</div>
                        <div className="text-sm font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wide">Colis Livrés</div>
                    </div>
                    <div className="text-center space-y-2">
                        <div className="text-4xl lg:text-5xl font-bold text-blue-600 dark:text-blue-400">3</div>
                        <div className="text-sm font-bold text-slate-500 dark:text-slate-400 uppercase tracking-wide">Pays Desservis</div>
                    </div>
                </div>
            </div>
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8 py-24 sm:py-32">
                <div className="mx-auto max-w-2xl lg:text-center mb-20">
                    <h2 className="text-blue-600 font-bold tracking-widest uppercase text-sm mb-4">{about?.mission_title || 'Notre Mission'}</h2>
                    ...
                    <p className="text-lg leading-relaxed text-slate-600 dark:text-slate-400">
                        {about?.mission_desc || 'Nous croyons que le commerce international ne devrait pas être complexe. Notre mission est de fournir aux entrepreneurs africains les outils logistiques et financiers nécessaires pour développer leur activité sans frontières.'}
                    </p>
                </div>
                    ...
                    <dl className="grid max-w-xl grid-cols-1 gap-8 lg:max-w-none lg:grid-cols-2">
                        <div className="flex flex-col bg-slate-50 dark:bg-gray-900 rounded-[2.5rem] p-10 hover:bg-white dark:hover:bg-gray-800 border border-slate-100 dark:border-slate-800 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group">
                            ...
                            <dd className="flex flex-auto flex-col text-lg leading-relaxed text-slate-600 dark:text-slate-400">
                                <p className="flex-auto">{about?.vision_desc || "Devenir le pont numérique incontournable connectant les marchés mondiaux à l'Afrique, en rendant l'importation aussi simple qu'un achat local."}</p>
                            </dd>
                        </div>
                        ...
                        <div className="flex flex-col bg-slate-50 dark:bg-gray-900 rounded-[2.5rem] p-10 hover:bg-white dark:hover:bg-gray-800 border border-slate-100 dark:border-slate-800 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group">
                            ...
                            <dd className="flex flex-auto flex-col text-lg leading-relaxed text-slate-600 dark:text-slate-400">
                                <p className="flex-auto">{about?.values_desc || "Transparence totale, Fiabilité absolue, Innovation constante et Satisfaction Client sont les piliers de notre entreprise."}</p>
                            </dd>
                        </div>
                        ...
                        <div className="flex flex-col bg-slate-50 dark:bg-gray-900 rounded-[2.5rem] p-10 hover:bg-white dark:hover:bg-gray-800 border border-slate-100 dark:border-slate-800 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group">
                            ...
                            <dd className="flex flex-auto flex-col text-lg leading-relaxed text-slate-600 dark:text-slate-400">
                                <p className="flex-auto">Une équipe d'experts multilingues passionnés, disponible pour vous accompagner personnellement à chaque étape de votre expédition.</p>
                            </dd>
                        </div>
                        ...
                        <div className="flex flex-col bg-slate-50 dark:bg-gray-900 rounded-[2.5rem] p-10 hover:bg-white dark:hover:bg-gray-800 border border-slate-100 dark:border-slate-800 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group">
                            ...
                            <dd className="flex flex-auto flex-col text-lg leading-relaxed text-slate-600 dark:text-slate-400">
                                <p className="flex-auto">Nous développons constamment de nouvelles technologies pour rendre la logistique plus transparente, plus rapide et plus efficace pour tous.</p>
                            </dd>
                        </div>
                    </dl>
                </div>
            ...
            <div className="bg-slate-900 py-24 relative overflow-hidden">
                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8 relative z-10 text-center">
                    ...
                    <p className="mx-auto max-w-2xl text-lg leading-8 text-slate-300 mb-10">
                        Rejoignez des milliers d'entrepreneurs qui font confiance à NextMove Cargo pour leurs importations.
                    </p>
                    <div className="flex items-center justify-center gap-x-6">
                        ...
                        <a href="/contact" className="text-lg font-semibold leading-6 text-white hover:text-blue-300 transition-colors">
