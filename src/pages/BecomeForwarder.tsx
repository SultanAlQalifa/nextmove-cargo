                ...
                <div className="p-8">
                    <div className="flex items-center justify-between mb-6">
                        <div className="flex items-center gap-3">
                            ...
                            <h2 className="text-2xl font-bold text-slate-900 dark:text-white">Devenir Partenaire Transitaire</h2>
                        </div>
                    ...
                    <div className="prose prose-slate dark:prose-invert max-w-none mb-8">
                        <p className="lead text-lg text-slate-600 dark:text-slate-300">
                            En rejoignant le réseau NextMove Cargo, vous vous engagez à fournir un service d'excellence.
                            Veuillez lire attentivement les conditions ci-dessous.
                        </p>
                        ...
                        <div className="bg-slate-50 dark:bg-slate-800/50 p-6 rounded-2xl border border-slate-100 dark:border-slate-700 not-prose space-y-4 my-6">
                            ...
                            <ul className="space-y-3">
                                <li className="flex items-start gap-3 text-slate-600 dark:text-slate-300 text-sm">
                                    ...
                                    <span>Je certifie posséder les documents requis (registre de commerce, NINEA, carte import-export, carte commerçant, entrepôt local, visa Chine/Dubaï valide ou tout autre pays d'exercice).</span>
                                </li>
                                <li className="flex items-start gap-3 text-slate-600 dark:text-slate-300 text-sm">
                                    <CheckCircle className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
                                    <span>Je certifie posséder les documents requis (registre de commerce, NINEA, carte import-export, carte commerçant, entrepôt local, visa Chine/Dubaï valide ou tout autre pays d'exercice).</span>
                                ...
                                <li className="flex items-start gap-3 text-slate-600 dark:text-slate-300 text-sm">
                                    <CheckCircle className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
                                    <span>Je m'engage à respecter les délais annoncés et à communiquer proactivement avec les clients.</span>
                                </li>
                                <li className="flex items-start gap-3 text-slate-600 dark:text-slate-300 text-sm">
                                    <CheckCircle className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
                                    <span>J'accepte que NextMove Cargo vérifie mes documents et suspende mon compte en cas de non-conformité.</span>
                                </li>
                            </ul>
                        </div>

                        <p className="text-sm text-slate-500 dark:text-slate-400">
                            Un contrat détaillé vous sera envoyé par email après validation de ce formulaire.
                        </p>
                    </div>

                    <form onSubmit={handleSubmit} className="space-y-6 border-t border-slate-100 dark:border-slate-800 pt-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                <label className="text-sm font-bold text-slate-700 dark:text-slate-300">Nom Complet (Signature)</label>
                        ...
                        <label className="flex items-start gap-3 p-4 rounded-xl bg-blue-50 dark:bg-blue-900/10 cursor-pointer hover:bg-blue-100 dark:hover:bg-blue-900/20 transition-colors">
                            ...
                            <span className="text-sm text-slate-700 dark:text-slate-300">
                                Je reconnais avoir lu et accepté les conditions ci-dessus. Je consens à la signature électronique de cet engagement.
                            </span>
                        </label>
...
export default function BecomeForwarder() {
    ...
    const categories = [
        { id: 'core', label: 'Fonctionnalités Clés', icon: Zap, color: 'text-purple-600 bg-purple-50' },
        { id: 'usage', label: 'Limites & Usage', icon: Hash, color: 'text-blue-600 bg-blue-50' },
        { id: 'support', label: 'Support & Service', icon: Shield, color: 'text-green-600 bg-green-50' },
        { id: 'integration', label: 'Intégrations', icon: Layers, color: 'text-orange-600 bg-orange-50' },
    ];
    ...
    return (
        <div className="min-h-screen bg-white dark:bg-gray-950">
            ...
            <div className="relative min-h-[70vh] flex items-center overflow-hidden">
                ...
                <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 text-center">
                    <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full bg-white/5 border border-white/10 backdrop-blur-md mb-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
                        ...
                        <span className="text-sm font-medium text-blue-100 tracking-wide uppercase">Rejoignez le réseau leader</span>
                    </div>
                    ...
                    <h1 className="text-5xl lg:text-7xl font-bold text-white mb-8 leading-tight tracking-tight max-w-5xl mx-auto animate-in fade-in slide-in-from-bottom-6 duration-700 delay-100">
                        Développez votre activité avec <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-300">NextMove Cargo</span>
                    </h1>
                    ...
                    <p className="text-xl text-slate-300 mb-12 max-w-2xl mx-auto font-light leading-relaxed animate-in fade-in slide-in-from-bottom-8 duration-700 delay-200">
                        Rejoignez notre réseau de transitaires certifiés. Accédez à des milliers de demandes de cotation, gérez vos expéditions et simplifiez votre facturation.
                    </p>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
                        <div className="space-y-2">
                            ...
                            <div className="text-sm font-medium text-slate-500 dark:text-slate-400 uppercase tracking-wide">Transitaires Actifs</div>
                        </div>
                        <div className="space-y-2">
                            <div className="text-4xl font-bold text-blue-600 dark:text-blue-400">10k+</div>
                            <div className="text-sm font-medium text-slate-500 dark:text-slate-400 uppercase tracking-wide">Expéditions / Mois</div>
                        </div>
                        <div className="space-y-2">
                            <div className="text-4xl font-bold text-blue-600 dark:text-blue-400">98%</div>
                            <div className="text-sm font-medium text-slate-500 dark:text-slate-400 uppercase tracking-wide">Satisfaction Client</div>
                        </div>
                        <div className="space-y-2">
                            <div className="text-4xl font-bold text-blue-600 dark:text-blue-400">24/7</div>
                            <div className="text-sm font-medium text-slate-500 dark:text-slate-400 uppercase tracking-wide">Support Dédié</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="py-24 bg-slate-50 dark:bg-gray-950 relative overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="text-center mb-20">
                        <h2 className="text-blue-600 font-bold tracking-widest uppercase text-sm mb-4">Avantages</h2>
                        <h2 className="text-4xl lg:text-5xl font-bold text-slate-900 dark:text-white mb-6">Pourquoi nous rejoindre ?</h2>
                        <p className="text-xl text-slate-500 dark:text-slate-400 max-w-2xl mx-auto font-light">Des outils puissants conçus pour les professionnels de la logistique moderne.</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="group bg-white dark:bg-gray-900 p-10 rounded-[2.5rem] shadow-xl shadow-slate-200/50 dark:shadow-none border border-slate-100 dark:border-slate-800 hover:-translate-y-2 transition-all duration-300">
                            ...
                            <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">Visibilité Mondiale</h3>
                            <p className="text-slate-500 dark:text-slate-400 leading-relaxed text-lg">
                                Touchez des clients internationaux et développez votre présence sur de nouveaux marchés sans effort marketing supplémentaire.
                            </p>
                        </div>
                        <div className="group bg-white dark:bg-gray-900 p-10 rounded-[2.5rem] shadow-xl shadow-slate-200/50 dark:shadow-none border border-slate-100 dark:border-slate-800 hover:-translate-y-2 transition-all duration-300">
                            ...
                            <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">Plus de Business</h3>
                            <p className="text-slate-500 dark:text-slate-400 leading-relaxed text-lg">
                                Recevez des demandes de cotation (RFQ) qualifiées directement sur votre tableau de bord et répondez-y en quelques clics.
                            </p>
                        </div>
                        <div className="group bg-white dark:bg-gray-900 p-10 rounded-[2.5rem] shadow-xl shadow-slate-200/50 dark:shadow-none border border-slate-100 dark:border-slate-800 hover:-translate-y-2 transition-all duration-300">
                            ...
                            <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">Gestion Simplifiée</h3>
                            <p className="text-slate-500 dark:text-slate-400 leading-relaxed text-lg">
                                Un outil tout-en-un pour gérer vos expéditions, votre tracking, vos documents et votre facturation.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="bg-slate-50 dark:bg-gray-800/30 rounded-[3rem] p-8 md:p-16 border border-slate-100 dark:border-slate-700 flex flex-col lg:flex-row items-center gap-16">
                        <div className="flex-1 space-y-8">
                            <div>
                                <h2 className="text-3xl lg:text-4xl font-bold text-slate-900 dark:text-white mb-6">Conditions d'Éligibilité</h2>
                                <p className="text-lg text-slate-500 dark:text-slate-400">Nous maintenons un standard de qualité élevé pour garantir la confiance de nos clients.</p>
                            </div>
                            ...
                            <div className="space-y-6">
                                <div className="flex items-start gap-6 group">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-slate-900 dark:text-white text-xl mb-2">Documents Requis</h4>
                                        <p className="text-slate-500 dark:text-slate-400 leading-relaxed">Vous devez posséder les documents requis (registre de commerce, NINEA, carte import-export, carte commerçant, entrepôt local, visa Chine/Dubaï valide ou tout autre pays d'exercice).</p>
                                    </div>
                                </div>
                                <div className="flex items-start gap-6 group">
                                    <div className="p-4 bg-white dark:bg-gray-900 text-green-600 dark:text-green-400 rounded-2xl shadow-sm group-hover:scale-110 transition-transform duration-300">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-slate-900 dark:text-white text-xl mb-2">Assurance Responsabilité Civile</h4>
                                        <p className="text-slate-500 dark:text-slate-400 leading-relaxed">Une assurance RC Pro couvrant vos activités de transport est fortement recommandée.</p>
                                    </div>
                                </div>
                                <div className="flex items-start gap-6 group">
                                    <div className="p-4 bg-white dark:bg-gray-900 text-green-600 dark:text-green-400 rounded-2xl shadow-sm group-hover:scale-110 transition-transform duration-300">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-slate-900 dark:text-white text-xl mb-2">Qualité de Service</h4>
                                        <p className="text-slate-500 dark:text-slate-400 leading-relaxed">Engagement à respecter nos standards de qualité et de réactivité envers les clients.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="flex-1 w-full lg:w-auto bg-white dark:bg-gray-900 rounded-[2.5rem] p-12 text-center shadow-2xl shadow-slate-200/50 dark:shadow-none border border-slate-100 dark:border-slate-800 relative overflow-hidden">
                            ...
                            <h3 className="text-3xl font-bold text-slate-900 dark:text-white mb-6 relative z-10">Prêt à commencer ?</h3>
                            <p className="text-slate-500 dark:text-slate-400 mb-10 text-lg relative z-10">
                                L'inscription est rapide. Une fois vos documents vérifiés, vous pourrez commencer à recevoir des demandes.
                            </p>
                            <button
                                onClick={() => setIsModalOpen(true)}
            ...
            {/* Plans Section */}
            <div id="plans" className="py-24 bg-slate-50 dark:bg-gray-950">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-20">
                        <h2 className="text-3xl lg:text-4xl font-bold text-slate-900 dark:text-white mb-4">Nos Offres Partenaires</h2>
                        <p className="text-xl text-slate-500 dark:text-slate-400">Choisissez le plan adapté à la taille de votre entreprise</p>
                    </div>
                    ...
                    {loading ? (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
                            {plans.map((plan) => {
                                ...
                                return (
                                    <div key={plan.id} className={`bg-white dark:bg-gray-900 rounded-[2.5rem] shadow-xl shadow-slate-200/50 dark:shadow-none border ${isPro ? 'border-blue-500 ring-4 ring-blue-500/10' : 'border-slate-100 dark:border-slate-800'} overflow-hidden flex flex-col hover:-translate-y-2 transition-all duration-300 relative group`}>
                                        {/* Popular Badge Logic */}
                                        {isPro && (
                                                    ...
                                                    return (
                                                        <div key={cat.id}>
                                                            <div className="flex items-center gap-3 mb-5">
                                                                <div className={`p-2 rounded-xl ${cat.color} bg-opacity-10`}>
                                                                    <cat.icon className="w-4 h-4" />
                                                                </div>
                                                                <h5 className="text-xs font-bold text-slate-400 uppercase tracking-wider">{cat.label}</h5>
                                                            </div>
                                                                ...
                                                                {catDefinitions.map((def) => {
                                                                    ...
                                                                    return (
                                                                        <div key={def.id} className="flex items-start gap-3">
                                                                            <div className={`mt-1 ${def.type === 'limit' ? 'text-blue-600' : 'text-green-500'}`}>
                                                                                {def.type === 'limit' ? <Hash className="w-5 h-5" /> : <Check className="w-5 h-5" />}
                                                                            </div>
