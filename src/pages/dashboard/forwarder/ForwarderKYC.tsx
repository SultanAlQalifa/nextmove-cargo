...
import { FileText, Upload, CheckCircle, XCircle, Clock, Eye, AlertTriangle, Save } from 'lucide-react';
                ...
                {loadingDocs ? (
                    ...
                    <div className="grid grid-cols-1 gap-4">
                        {requiredDocuments.map((doc) => {
                            ...
                            return (
                                <div key={doc.id} className="border border-gray-100 rounded-xl p-4 flex flex-col sm:flex-row sm:items-center justify-between gap-4 hover:border-gray-200 transition-colors">
                                    <div className="flex items-start gap-4">
                                        <div className={`p-3 rounded-xl ${status === 'verified' ? 'bg-green-50 text-green-600' :
                                        ...
                                        {(status === 'missing' || status === 'rejected') && (
                                            <label className="cursor-pointer">
                                                <input
                                                    ...
                                                    onChange={(e) => e.target.files?.[0] && handleDocumentUpload(e.target.files[0], doc.id)}
                                                />
