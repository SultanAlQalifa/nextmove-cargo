...
import { Bell, Lock, Save, AlertTriangle, User, Camera, Mail, Phone, Key, Building, FileText, Upload, CheckCircle, XCircle, Clock, Eye, CreditCard, Star, Check } from 'lucide-react';
...
type SettingsTab = 'profile' | 'notifications' | 'security' | 'documents' | 'subscription';
...
export default function ForwarderSettings() {
    ...
    useEffect(() => {
        ...
        if (tab && ['profile', 'notifications', 'security', 'documents', 'subscription'].includes(tab)) {
    ...
    const requiredDocuments = [
        { id: 'registre_commerce', label: 'Registre de Commerce (RC)', description: 'Document officiel d\'immatriculation' },
        { id: 'ninea', label: 'NINEA', description: 'Numéro d\'Identification Nationale des Entreprises et Associations' },
        { id: 'carte_import_export', label: 'Carte Import-Export', description: 'Carte valide pour l\'année en cours' },
        { id: 'assurance_rc', label: 'Assurance RC Pro', description: 'Attestation d\'assurance responsabilité civile' },
    ];
        ...
        <div>
            <PageHeader
                ...
                action={{
                    ...
                    onClick: handleSave,
                    icon: Save,
                    disabled: saving || activeTab === 'documents' || activeTab === 'subscription' // Auto-save for docs & sub
                }}
            />
                            ...
                            <div className="space-y-8">
                                ...
                                <div className="flex items-center gap-6 pb-6 border-b border-gray-100">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-500 text-sm capitalize">{userProfile.role === 'forwarder' ? 'Transitaire' : userProfile.role}</p>
                                    </div>
                                </div>
                                ...
                                <div className="space-y-6">
                                    <div className="p-4 bg-blue-50 rounded-xl border border-blue-100">
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div>
                                                <p className="font-medium text-blue-900">Mot de passe</p>
                                                <p className="text-sm text-blue-700 mt-1">
                                                    Pour votre sécurité, utilisez un mot de passe fort contenant au moins 8 caractères, des chiffres et des symboles.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
