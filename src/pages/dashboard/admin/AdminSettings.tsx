                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                    <div>
                      ...
                      <p className="text-sm text-gray-500">
                        Autoriser les utilisateurs à s'inscrire et se connecter avec un numéro de téléphone
                      </p>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input
                        type="checkbox"
                        checked={localSettings.security.phone_auth_enabled ?? true}
                        aria-label="Activer l'authentification par téléphone"
                        onChange={(e) =>
                          updateSetting(
                            "security",
                            "phone_auth_enabled",
