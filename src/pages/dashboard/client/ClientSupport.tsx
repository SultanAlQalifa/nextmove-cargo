...
import { MessageCircle, Plus, Search, HelpCircle, FileText, Phone } from 'lucide-react';
        ...
        <div className="space-y-8 pb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all cursor-pointer group">
                    ...
                    <p className="text-sm text-gray-500">Consultez nos questions fréquentes pour des réponses rapides.</p>
                </div>
                ...
                <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all cursor-pointer group">
                    ...
                    <p className="text-sm text-gray-500">Guides détaillés sur l'utilisation de la plateforme.</p>
                </div>
                ...
                <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all cursor-pointer group">
                    ...
                    <p className="text-sm text-gray-500">Appelez-nous directement pour les urgences.</p>
                </div>
            </div>
            ...
            <div>
                ...
                {loading ? (
                    ...
                    <div className="text-center py-12 bg-white rounded-2xl border border-gray-100 border-dashed">
                        ...
                        <p className="text-gray-500 mt-1">Vous n'avez pas encore créé de ticket de support.</p>
                        <button
                            onClick={() => setIsCreateModalOpen(true)}
