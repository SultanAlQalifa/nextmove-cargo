...
import { Bell, Lock, Save, AlertTriangle, User, Camera, Mail, Phone, Key, Building, Briefcase } from 'lucide-react';
                        ...
                        {activeTab === 'profile' && (
                            <div className="space-y-8">
                                ...
                                <div className="flex items-center gap-6 pb-6 border-b border-gray-100">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-bold text-gray-900">{userProfile.full_name || 'Client'}</h3>
                        ...
                        {activeTab === 'notifications' && (
                            <div className="space-y-6">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                                        <div>
                                            <p className="font-medium text-gray-900">Nouvelles Offres</p>
                                            <p className="text-sm text-gray-500">Être alerté des nouvelles offres des transitaires</p>
                                        </div>
                                        <label className="relative inline-flex items-center cursor-pointer">
                                            <input
                                                type="checkbox"
                                                checked={notifications.offers_enabled}
                                                onChange={(e) => setNotifications({ ...notifications, offers_enabled: e.target.checked })}
                                                className="sr-only peer"
                                            />
                                            <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-primary/20 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-primary"></div>
                                        </label>
                            ...
                            <div className="mt-8 pt-8 border-t border-gray-100">
                                <div className="bg-blue-50 rounded-xl p-6 border border-blue-100">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div className="flex-1">
                                            <h3 className="text-lg font-bold text-gray-900 mb-2">Devenir Transitaire</h3>
                                            <p className="text-gray-600 mb-4">
                                                Vous souhaitez proposer vos services de transport sur notre plateforme ?
                                                Passez à un compte professionnel pour gérer vos expéditions, publier des offres de groupage et développer votre activité.
                                            </p>
                                            <button
                                                onClick={() => setConfirmModal({
                                                    ...
                                                    message: 'En devenant transitaire, vous aurez accès à un tableau de bord dédié. Vous devrez ensuite souscrire à un abonnement et valider votre KYC pour commencer à opérer. Voulez-vous continuer ?',
                                                    variant: 'info'
                                                })}
