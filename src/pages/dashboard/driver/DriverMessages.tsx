...
export default function DriverMessages() {
    ...
    const chats = [
        { id: 1, name: 'Support NextMove', lastMessage: 'Bonjour, avez-vous pu livrer ?', time: '10:30', unread: 2 },
        { id: 2, name: 'Transitaire Alpha', lastMessage: 'Nouvelle mission disponible.', time: 'Hier', unread: 0 }
    ];

    const messages = [
        { id: 1, sender: 'them', text: 'Bonjour, avez-vous pu livrer le colis TRK-123 ?', time: '10:30' },
        { id: 2, sender: 'me', text: 'Oui, je viens de soumettre le POD.', time: '10:32' },
                    ...
                    {chats.map(chat => (
                        ...
                        >
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                {chat.unread > 0 && (
                                    <span className="bg-primary text-white text-xs font-bold px-2 py-0.5 rounded-full">{chat.unread}</span>
                                )}
                            </div>
                        </div>
                    ))}
                ...
                {selectedChat ? (
                    <>
                        ...
                        <div className="p-4 bg-white border-t border-gray-200">
                            <form
                                onSubmit={(e) => { e.preventDefault(); setMessageInput(''); }}
                            ...
                            >
                                ...
                                />
                                <button type="submit" className="bg-primary text-white p-2 rounded-lg hover:bg-blue-700 transition-colors">
