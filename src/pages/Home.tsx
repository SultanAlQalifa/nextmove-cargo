...
export default function Home() {
  ...
  return (
    <div className="bg-slate-50 dark:bg-gray-950 transition-colors duration-300 font-sans">
      ...
      <div className="py-32 bg-gradient-to-b from-slate-50 to-white dark:from-slate-950 dark:to-slate-900 border-y border-slate-100/80 dark:border-white/5 relative overflow-hidden">
        {/* Ambient glows */}
        <div className="absolute top-0 left-1/4 w-[500px] h-[500px] bg-blue-500/8 rounded-full blur-[100px] pointer-events-none" />
        <div className="absolute bottom-0 right-1/4 w-[400px] h-[400px] bg-orange-500/8 rounded-full blur-[100px] pointer-events-none" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-emerald-100 dark:bg-emerald-900/30 text-emerald-600 dark:text-emerald-400 font-bold text-[10px] tracking-[0.2em] uppercase mb-6">
              <ShieldCheck className="w-4 h-4" /> Paiements 100% Sécurisés
            </div>
            <h2 className="text-4xl lg:text-6xl font-black text-slate-900 dark:text-white mb-6 leading-tight tracking-tight">
              Payez comme vous{" "}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-blue-600">voulez</span>
            </h2>
            <p className="text-xl text-slate-500 dark:text-slate-400 max-w-2xl mx-auto leading-relaxed font-light">
              NextMove Cargo prend en charge tous les modes de paiement populaires en Afrique — mobile money, carte bancaire, portefeuille ou espèces.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
            ...
            <motion.div
              ...
              className="group relative bg-white dark:bg-slate-800/60 rounded-3xl p-8 border border-slate-100 dark:border-white/5 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300"
            >
              <div className="mb-6 h-14 flex items-center">
                <img src="/assets/wave-icon.png" alt="Wave" className="h-12 w-12 rounded-2xl object-cover" />
              </div>
              <h3 className="text-xl font-black text-slate-900 dark:text-white mb-2">Wave</h3>
              <p className="text-slate-500 dark:text-slate-400 text-sm leading-relaxed mb-5">
                Paiement instantané par Wave Money. Frais parmi les plus bas du marché.
              </p>
              <div className="flex flex-wrap gap-2">
                <span className="px-3 py-1 rounded-full bg-[#1DA1F2]/10 text-[#1DA1F2] text-xs font-bold">Sénégal</span>
                <span className="px-3 py-1 rounded-full bg-[#1DA1F2]/10 text-[#1DA1F2] text-xs font-bold">Côte d'Ivoire</span>
                <span className="px-3 py-1 rounded-full bg-slate-100 dark:bg-slate-700 text-slate-500 dark:text-slate-400 text-xs font-bold">1% frais</span>
              </div>
            </motion.div>
            ...
            >
              <div className="mb-6 h-14 flex items-center">
                <img src="/assets/paytech-logo.png" alt="PayTech" className="h-10 object-contain" />
              </div>
              <h3 className="text-xl font-black text-slate-900 dark:text-white mb-1">PayTech</h3>
              <span className="text-[10px] font-bold text-orange-500 uppercase tracking-widest mb-3 block">Agrégateur</span>
              <p className="text-slate-500 dark:text-slate-400 text-sm leading-relaxed mb-5">
                Via PayTech, payez avec Orange Money, Wave, carte bancaire et bien plus.
              </p>
              <div className="flex flex-wrap gap-2">
                <span className="px-3 py-1 rounded-full bg-orange-50 dark:bg-orange-900/20 text-orange-500 text-xs font-bold">Orange Money</span>
                <span className="px-3 py-1 rounded-full bg-[#1DA1F2]/10 text-[#1DA1F2] text-xs font-bold">Wave</span>
                <span className="px-3 py-1 rounded-full bg-slate-100 dark:bg-slate-700 text-slate-500 dark:text-slate-400 text-xs font-bold">Carte</span>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              className="group relative bg-white dark:bg-slate-800/60 rounded-3xl p-8 border border-slate-100 dark:border-white/5 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300"
            >
              <div className="mb-6 h-14 flex items-center text-slate-900 dark:text-white">
                <svg viewBox="0 0 220 55" className="h-9" xmlns="http://www.w3.org/2000/svg">
                  <text x="0" y="43" fontFamily="Georgia, serif" fontSize="40" fontWeight="700" fill="currentColor">Cinet</text>
                  <text x="110" y="43" fontFamily="Georgia, serif" fontSize="40" fontWeight="700" fill="#e53e3e">Pay</text>
                </svg>
              </div>
              <h3 className="text-xl font-black text-slate-900 dark:text-white mb-1">CinetPay</h3>
              <span className="text-[10px] font-bold text-red-500 uppercase tracking-widest mb-3 block">Agrégateur</span>
              <p className="text-slate-500 dark:text-slate-400 text-sm leading-relaxed mb-5">
                Paiements multi-opérateurs en Afrique de l'Ouest via CinetPay.
              </p>
              <div className="flex flex-wrap gap-2">
                <span className="px-3 py-1 rounded-full bg-yellow-50 dark:bg-yellow-900/20 text-yellow-600 text-xs font-bold">MTN MoMo</span>
                <span className="px-3 py-1 rounded-full bg-orange-50 dark:bg-orange-900/20 text-orange-500 text-xs font-bold">Orange Money</span>
                <span className="px-3 py-1 rounded-full bg-slate-100 dark:bg-slate-700 text-slate-500 dark:text-slate-400 text-xs font-bold">+5 réseaux</span>
              </div>
            </motion.div>
          </div>

          {/* Bottom row: Portefeuille + Cash */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            ...
            <motion.div
              ...
              className="group relative bg-gradient-to-br from-primary/5 to-blue-600/5 dark:from-primary/10 dark:to-blue-600/10 rounded-3xl p-8 border border-primary/20 dark:border-primary/20 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300"
            >
              <div className="flex items-start justify-between mb-6">
                <div className="w-14 h-14 rounded-2xl bg-primary/10 flex items-center justify-center">
                  <CreditCard className="w-7 h-7 text-primary" />
                </div>
                <span className="px-3 py-1 rounded-full bg-primary/10 text-primary text-xs font-black uppercase tracking-wider">Recommandé</span>
              </div>
              <h3 className="text-xl font-black text-slate-900 dark:text-white mb-2">Portefeuille NextMove</h3>
              <p className="text-slate-500 dark:text-slate-400 text-sm leading-relaxed mb-5">
                Rechargez votre portefeuille intégré une fois, payez en un clic pour toutes vos expéditions. Solde disponible instantanément.
              </p>
              <div className="flex flex-wrap gap-2">
                <span className="px-3 py-1 rounded-full bg-primary/10 text-primary text-xs font-bold">0% frais internes</span>
                <span className="px-3 py-1 rounded-full bg-emerald-50 dark:bg-emerald-900/20 text-emerald-600 text-xs font-bold">Rechargeable</span>
                <span className="px-3 py-1 rounded-full bg-blue-50 dark:bg-blue-900/20 text-blue-600 text-xs font-bold">Transferts</span>
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-start justify-between mb-6">
                ...
                <span className="px-3 py-1 rounded-full bg-emerald-50 dark:bg-emerald-900/20 text-emerald-600 text-xs font-bold uppercase tracking-wider">En agence</span>
              </div>
              <h3 className="text-xl font-black text-slate-900 dark:text-white mb-2">Paiement Cash</h3>
              <p className="text-slate-500 dark:text-slate-400 text-sm leading-relaxed mb-5">
                Déposez vos espèces directement en agence ou auprès de nos agents partenaires locaux.
              </p>
              <div className="flex flex-wrap gap-2">
                <span className="px-3 py-1 rounded-full bg-emerald-50 dark:bg-emerald-900/20 text-emerald-600 text-xs font-bold">XOF · EUR · USD</span>
                <span className="px-3 py-1 rounded-full bg-slate-100 dark:bg-slate-700 text-slate-500 dark:text-slate-400 text-xs font-bold">En agence</span>
              </div>
            </motion.div>
          </div>
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="flex flex-col sm:flex-row items-center justify-center gap-8 py-10 border-t border-slate-100 dark:border-white/5"
          >
            {[
              { icon: "🔒", label: "Paiements chiffrés SSL" },
              { icon: "⚡", label: "Confirmation en temps réel" },
              { icon: "🛡️", label: "Système Escrow sécurisé" },
              { icon: "📱", label: "Compatible mobile & web" },
            ].map((item, i) => (
          ...
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <div className="order-2 lg:order-1 relative">
              <div className="relative z-10 glass-card p-10 rounded-[3rem] border-slate-200 dark:border-white/5 bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl shadow-2xl shadow-blue-500/10">
                ...
                <div className="space-y-8">
                  <div className="flex items-center gap-6 p-4 bg-slate-50 dark:bg-white/5 rounded-2xl border border-slate-100 dark:border-white/10">
                    ...
                    <div>
                      <div className="text-slate-900 dark:text-white font-bold text-lg">Nouvelle Commission</div>
                      <div className="text-slate-500 dark:text-slate-400 text-sm">Il y a 2 minutes</div>
                    </div>
                    <div className="ml-auto text-emerald-600 dark:text-emerald-400 font-bold text-xl">+ 15.000 F</div>
                  </div>

                  <div className="flex items-center gap-6 p-4 bg-slate-50 dark:bg-white/5 rounded-2xl border border-slate-100 dark:border-white/10 opacity-60">
                    <div className="w-12 h-12 rounded-full bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 flex items-center justify-center">
                      <Plus className="w-6 h-6" />
                    </div>
                    <div>
                      <div className="text-slate-900 dark:text-white font-bold text-lg">Nouvelle Commission</div>
                      <div className="text-slate-500 dark:text-slate-400 text-sm">Il y a 2 heures</div>
                    </div>
                    <div className="ml-auto text-emerald-600 dark:text-emerald-400 font-bold text-xl">+ 25.000 F</div>
                  </div>
