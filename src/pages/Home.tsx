...
import { ArrowRight, ShieldCheck, Globe, Clock, CheckCircle, Star, Package, Truck, Anchor, ChevronRight, Play, Plane, Ship, FileText, Box, Home as HomeIcon } from 'lucide-react';
    ...
    const features = [
        {
            ...
            icon: ShieldCheck,
            classes: "bg-emerald-50 dark:bg-emerald-900/20 text-emerald-600 dark:text-emerald-400 group-hover:bg-emerald-600 group-hover:text-white"
        },
        {
            title: branding.features.multimodal_title,
            desc: branding.features.multimodal_desc,
            icon: Package,
            classes: "bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 group-hover:bg-blue-600 group-hover:text-white"
        },
        {
            title: branding.features.tracking_title,
            desc: branding.features.tracking_desc,
            icon: Truck,
            classes: "bg-indigo-50 dark:bg-indigo-900/20 text-indigo-600 dark:text-indigo-400 group-hover:bg-indigo-600 group-hover:text-white"
        }
    ];
    ...
    return (
        <div className="bg-slate-50 dark:bg-gray-950 transition-colors duration-300 font-sans">
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        ...
                        <div className="space-y-10">
                            <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full bg-white/5 border border-white/10 backdrop-blur-md">
                                ...
                                <span className="text-sm font-medium text-blue-100 tracking-wide uppercase">Leader en Logistique Digitale</span>
                            </div>

                            <h1 className="text-5xl lg:text-7xl font-bold text-white leading-[1.1] tracking-tight">
                                {branding.hero.title.split(' ').map((word, i) => (
                                    <span key={i} className={i === 1 ? "text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-300" : ""}>
                                        {word}{' '}
                                    </span>
                                ))}
                            </h1>
                            ...
                            <div className="flex items-center gap-8 pt-8 border-t border-white/10">
                                <div className="flex -space-x-4">
                                    {[1, 2, 3, 4].map(i => (
                                        <div key={i} className="w-12 h-12 rounded-full border-2 border-slate-900 bg-slate-800 flex items-center justify-center text-xs text-white font-bold ring-2 ring-slate-900">
                                            {i}k
                                        </div>
                                    ))}
                                </div>
                                <div>
                                    <div className="text-white font-bold text-lg">10k+ Clients</div>
                        ...
                        <div className="hidden lg:block relative perspective-1000">
                            ...
                            <div className="relative z-10 bg-slate-900/60 backdrop-blur-2xl border border-white/10 rounded-[2.5rem] p-8 shadow-2xl transform rotate-y-12 hover:rotate-y-0 transition-all duration-700">
                                <div className="flex justify-between items-center mb-10">
                                    <div>
                                        <div className="text-sm text-slate-400 font-medium mb-1">Statut de l'envoi</div>
                                        <div className="text-2xl font-bold text-white tracking-tight">En Transit</div>
                                    </div>
                                ...
                                <div className="space-y-10 relative pl-4">
                                    ...
                                    <div className="relative flex gap-6 items-center">
                                        ...
                                        <div>
                                            <div className="text-white font-bold text-lg">Colis Réceptionné</div>
                                            <div className="text-sm text-slate-400">Guangzhou, Chine • 09:00 AM</div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="relative flex gap-6 items-center">
                                        ...
                                        <div>
                                            <div className="text-white font-bold text-lg">Départ Navire</div>
                                            <div className="text-sm text-slate-400">Port de Shenzhen • En cours</div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="relative flex gap-6 items-center opacity-50">
                                        ...
                                        <div>
                                            <div className="text-white font-bold text-lg">Arrivée Prévue</div>
                                            <div className="text-sm text-slate-400">Dakar, Sénégal • 15 Nov</div>
                                        </div>
                                    </div>
                                </div>

                                <div className="mt-10 pt-8 border-t border-white/10 flex justify-between items-center">
                                    <div className="text-sm text-slate-400">Tracking ID: <span className="text-white font-mono font-medium ml-2">NMC-882910</span></div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-12 text-center">
                        {[
                            ...
                            { label: branding.stats.value, value: formatLargeNumber(50000000, currency) + "+", icon: Globe },
                            { label: branding.stats.forwarders, value: "500+", icon: Truck },
                            { label: branding.stats.success, value: "99.9%", icon: CheckCircle },
                        ].map((stat, idx) => (
                            <div key={idx} className="group p-6 rounded-3xl hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-all duration-300">
                                <div className="text-4xl lg:text-5xl font-bold text-slate-900 dark:text-white mb-3 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors transform group-hover:scale-110 duration-300 inline-block">{stat.value}</div>
            ...
            <div className="py-32 bg-slate-50 dark:bg-gray-950">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-24">
                        <h2 className="text-blue-600 dark:text-blue-400 font-bold tracking-widest uppercase text-sm mb-4">{branding.features.title}</h2>
                    ...
                    <div className="grid md:grid-cols-3 gap-10">
                        {features.map((feature, idx) => (
                            <div key={idx} className="group p-10 bg-white dark:bg-gray-900 rounded-[2rem] shadow-xl shadow-blue-500/5 dark:shadow-none hover:shadow-2xl hover:shadow-blue-500/10 hover:-translate-y-2 transition-all duration-500 border border-slate-100 dark:border-gray-800 relative overflow-hidden">
                                ...
                                <div className={`w-20 h-20 rounded-3xl flex items-center justify-center mb-10 transition-all duration-500 ${feature.classes} relative z-10`}>
                    ...
                    <div className="grid md:grid-cols-2 gap-24 items-center">
                        <div>
                            ...
                            <p className="text-xl text-slate-600 dark:text-slate-300 mb-12 leading-relaxed font-light">
                                NextMove Cargo intègre Wave pour offrir une expérience de paiement fluide, sécurisée et adaptée aux besoins des entreprises africaines.
                            </p>

                            <div className="space-y-8 mb-12">
                                {[
                                    { title: "Transactions Instantanées", desc: "Vos paiements sont validés en temps réel." },
                                    { title: "Frais Réduits (1%)", desc: "Profitez des frais les plus bas du marché." },
                                    { title: "Sécurité Maximale", desc: "Vos fonds sont protégés par les standards bancaires." }
                                ].map((item, i) => (
                                    <div key={i} className="flex items-start gap-5">
                                        ...
                                        <div>
                                            <h4 className="font-bold text-slate-900 dark:text-white text-xl mb-1">{item.title}</h4>
                                ...
                                <div className="flex items-center justify-between mb-12 border-b border-slate-100 dark:border-slate-700 pb-8">
                                    <div className="flex items-center gap-5">
                                        <div className="w-16 h-16 bg-[#1DA1F2] rounded-2xl flex items-center justify-center text-white shadow-lg shadow-[#1DA1F2]/30 overflow-hidden">
                                            <img src="/assets/wave-icon.png" alt="Wave" className="w-full h-full object-cover" />
                                        </div>
                                        <div>
                                            <div className="font-bold text-slate-900 dark:text-white text-2xl">Wave Money</div>
                                            <div className="text-slate-500 dark:text-slate-400">Paiement Sécurisé</div>
                                        </div>
                                    </div>
                                    <div className="text-[#1DA1F2] font-bold bg-[#1DA1F2]/10 px-4 py-2 rounded-full">1% Frais</div>
                                </div>

                                <div className="space-y-8">
                                    <div className="bg-slate-50 dark:bg-slate-900/50 p-6 rounded-3xl flex justify-between items-center">
                                        <span className="text-slate-500 dark:text-slate-400 font-medium">Montant</span>
                                        <span className="font-bold text-slate-900 dark:text-white text-3xl">500.000 FCFA</span>
                                    </div>
                                    <div className="bg-slate-50 dark:bg-slate-900/50 p-6 rounded-3xl flex justify-between items-center">
                                        <span className="text-slate-500 dark:text-slate-400 font-medium">Destinataire</span>
                                        <span className="font-bold text-slate-900 dark:text-white text-lg">NextMove Cargo</span>
                                    </div>
                                    ...
                                    <div className="py-4">
                                        ...
                                        <div className="text-center text-sm text-slate-500 dark:text-slate-400 font-medium">Validation sécurisée en cours...</div>
                                    </div>
            ...
            <div className="py-32 bg-white dark:bg-gray-900">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-24">
                        <h2 className="text-blue-600 dark:text-blue-400 font-bold tracking-widest uppercase text-sm mb-4">{branding.howItWorks.title}</h2>
                    ...
                    <div className="grid md:grid-cols-4 gap-12 relative">
                        ...
                        {[
                            { step: 1, title: branding.howItWorks.step1_title, desc: branding.howItWorks.step1_desc, icon: FileText },
                            { step: 2, title: branding.howItWorks.step2_title, desc: branding.howItWorks.step2_desc, icon: Box },
                            { step: 3, title: branding.howItWorks.step3_title, desc: branding.howItWorks.step3_desc, icon: Ship },
                            { step: 4, title: branding.howItWorks.step4_title, desc: branding.howItWorks.step4_desc, icon: HomeIcon },
                        ].map((item, idx) => (
            ...
            <div className="py-32 bg-slate-50 dark:bg-gray-950">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <h2 className="text-4xl lg:text-5xl font-bold text-slate-900 dark:text-white text-center mb-24">{branding.testimonials.title}</h2>
                    <div className="grid md:grid-cols-3 gap-10">
                        {[
                            { text: branding.testimonials.review1_text, name: branding.testimonials.review1_name, role: branding.testimonials.review1_role, initial: "A" },
                            { text: branding.testimonials.review2_text, name: branding.testimonials.review2_name, role: branding.testimonials.review2_role, initial: "S" },
                            { text: branding.testimonials.review3_text, name: branding.testimonials.review3_name, role: branding.testimonials.review3_role, initial: "W" },
                        ].map((review, idx) => (
                            <div key={idx} className="bg-white dark:bg-gray-900 p-12 rounded-[2.5rem] shadow-xl shadow-slate-200/50 dark:shadow-none border border-slate-100 dark:border-slate-800 relative group hover:-translate-y-2 transition-transform duration-500">
                                <div className="absolute top-10 right-10 text-slate-100 dark:text-slate-800 text-9xl font-serif opacity-50 group-hover:scale-110 transition-transform duration-500">"</div>
                                <div className="flex gap-1 mb-8">
                                    {[...Array(5)].map((_, i) => (
                                        <Star key={i} className="h-5 w-5 text-yellow-400 fill-current" />
                                    ))}
                                </div>
                                <p className="text-slate-700 dark:text-slate-300 mb-10 italic text-lg leading-relaxed relative z-10 font-light">"{review.text}"</p>
            ...
            <div className="relative py-40 overflow-hidden">
                ...
                <div className="relative max-w-5xl mx-auto text-center px-4">
                    <h2 className="text-5xl lg:text-6xl font-bold text-white mb-8 leading-tight tracking-tight">{branding.cta.title}</h2>
                    <p className="text-2xl text-blue-100 mb-16 max-w-3xl mx-auto font-light">{branding.cta.subtitle}</p>
                    <Link
                        to="/register"
