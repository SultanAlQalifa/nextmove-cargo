...
export default function Contact() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        success('Merci de nous avoir contactés. Nous vous répondrons dans les plus brefs délais.');
                ...
                <div className="mx-auto max-w-2xl lg:max-w-none">
                    <div className="text-center mb-20">
                        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-blue-500/10 border border-blue-500/20 mb-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
                            ...
                            <span className="text-sm font-bold text-blue-600 dark:text-blue-400 uppercase tracking-wide">Support 24/7</span>
                        </div>
                        ...
                        <p className="text-xl leading-relaxed text-slate-600 dark:text-slate-400 max-w-2xl mx-auto font-light animate-in fade-in slide-in-from-bottom-6 duration-700 delay-200">
                            {contact?.subtitle || "Une question ? Un besoin spécifique ? Notre équipe est là pour vous aider. N'hésitez pas à nous écrire ou à nous rendre visite."}
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
                                ...
                                <div className="flex items-start gap-6">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-slate-600 dark:text-slate-400 leading-relaxed text-lg">
                                            {contact?.address || '123 Avenue de la Logistique, Dakar, Sénégal'}
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl rounded-[2rem] p-8 shadow-xl shadow-slate-200/50 dark:shadow-none border border-white/20 dark:border-gray-800 hover:-translate-y-1 transition-transform duration-300 group">
                                <div className="flex items-start gap-6">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-slate-600 dark:text-slate-400 mb-2">Du Lundi au Vendredi de 8h à 18h</p>
                                        <a className="text-xl font-bold text-slate-900 dark:text-white hover:text-blue-600 transition-colors" href={`tel:${contact?.phone || '+221338000000'}`}>
                            ...
                            <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl rounded-[2rem] p-8 shadow-xl shadow-slate-200/50 dark:shadow-none border border-white/20 dark:border-gray-800 hover:-translate-y-1 transition-transform duration-300 group">
                                <div className="flex items-start gap-6">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-slate-600 dark:text-slate-400 mb-2">Notre équipe vous répond sous 24h</p>
                                        <a className="text-xl font-bold text-slate-900 dark:text-white hover:text-blue-600 transition-colors" href={`mailto:${contact?.email || 'contact@nextmovecargo.com'}`}>
                        ...
                        <div className="bg-white dark:bg-gray-900 rounded-[3rem] p-10 lg:p-12 shadow-2xl shadow-blue-900/5 dark:shadow-none border border-slate-100 dark:border-slate-800 animate-in fade-in slide-in-from-right-8 duration-1000 delay-300">
                            <h3 className="text-3xl font-bold text-slate-900 dark:text-white mb-2">Envoyez-nous un message</h3>
                            <p className="text-slate-500 dark:text-slate-400 mb-10">Remplissez le formulaire ci-dessous et nous vous répondrons rapidement.</p>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                <div className="space-y-6">
                                    ...
                                    <div className="group">
                                        <label htmlFor="subject" className="block text-sm font-bold text-slate-700 dark:text-slate-300 mb-2 ml-1">
                                            Sujet
                                        </label>
                                        <input
                                            type="text"
